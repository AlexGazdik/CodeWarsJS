...
function task(w, n, c) {
    ...
    const employeeList = ["James", "John", "Robert", "Michael", "William"]
    return `It is ${w} today, ${employeeList[dayOfWeek.indexOf(w)]}, you have to work, you must spray ${n} trees and you need ${n * c} dollars to buy liquid`
  }
